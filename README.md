About nomad-camels-driver-agilent-34401a-feedstock
==================================================
...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/nomad-camels-driver-agilent-34401a-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/nomad-camels-driver-agilent-34401a-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add nomad-camels-driver-agilent-34401a
# for installing globally
pixi global install nomad-camels-driver-agilent-34401a
```
...
It is possible to list all of the versions of `nomad-camels-driver-agilent-34401a` available on your platform:
...
```
pixi search nomad-camels-driver-agilent-34401a --channel conda-forge
```
